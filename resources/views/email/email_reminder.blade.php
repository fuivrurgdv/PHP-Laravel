            	...
            	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
				          	...
				          	<h3 class="name">Gửi anh/chị{{ $name }}</h3>
				          	<span class="position">đơn đã gửi thành công</span>
				           	<p><a href="#" class="btn btn-primary">Quay về trang chủ</a></p>
